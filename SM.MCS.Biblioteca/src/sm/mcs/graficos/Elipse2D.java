 ...
 */
public class Elipse2D extends java.awt.geom.Ellipse2D.Float implements Forma2D {
     ...
     */
    public Elipse2D(float x, float y, float w, float h, Color colTrz, Color colRell,
    ...
    public Rectangulo2D getBoundingBox(){
        ...
        anchoAprox = this.width;
        altoAprox = this.height;
        Rectangulo2D bbox = new Rectangulo2D((float) this.getX(), (float) this.getY(), anchoAprox, altoAprox,
